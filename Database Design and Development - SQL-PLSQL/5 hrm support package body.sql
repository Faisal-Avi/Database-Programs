...
IS  
    ...
    -- Human Resource Management Support     
       AUTHORE             EMAIL                    DATE    
    Faisal Ahmed   faisalahmed.22@gmail.com      16/08/2023 
...
CREATE OR REPLACE PACKAGE BODY hrm_supp
IS  
    ...
    */
    ...
    BEGIN
        ...
        BEGIN
         ...
         select substr(DBMS_LOB.substr(l_clob, 4000),1,instr(DBMS_LOB.substr(l_clob, 4000),'(',1)-1) INTO l_text from dual;  
        EXCEPTION
            WHEN OTHERS THEN
            NULL;
        END;
        
        INSERT INTO ATTENDANCE_ACTIVITY(attendance_id,attendance_date, emp_id, attendance_status, unit_no, latitude, longitude, attendance_loc)
        VALUES(l_attendance_id,SYSDATE,p_empid,p_att_status,p_unit,p_latitude,p_longitude,l_text);
